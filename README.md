...
|------------|------------------|------------------|-----------------|-----------------|---------|
| 10         | 3,463            | 0.003            | 7,135           | 0.007           | 0.49x   |
| 100        | 170,732          | 0.171            | 104,734         | 0.105           | 1.63x   |
| 1,000      | 4,128,020        | 4.128            | 235,323         | 0.235           | 17.54x  |
| 5,000      | 18,402,214       | 18.402           | 819,955         | 0.820           | 22.44x  |

### Sorting Performance - Sorted Data

| Array Size | Bubble Sort (ns) | Bubble Sort (ms) | Merge Sort (ns) | Merge Sort (ms) | Speedup |
|------------|------------------|------------------|-----------------|-----------------|---------|
| 10         | 1,569            | 0.002            | 10,144          | 0.010           | 0.15x   |
| 100        | 3,226            | 0.003            | 13,961          | 0.014           | 0.23x   |
| 1,000      | 256,258          | 0.256            | 120,037         | 0.120           | 2.13x   |
| 5,000      | 5,377            | 0.005            | 523,414         | 0.523           | 0.01x   |

### Binary Search Performance (Sorted Arrays)

| Array Size | First Element (ns) | Middle Element (ns) | Last Element (ns) | Not Found (ns) |
|------------|-------------------|---------------------|-------------------|----------------|
| 10         | 2,294             | 1,327               | 938               | 1,091          |
| 100        | 1,119             | 1,464               | 985               | 1,057          |
| 1,000      | 1,380             | 1,402               | 1,429             | 1,030          |
| 5,000      | 1,532             | 1,272               | 1,644             | 2,424          |
